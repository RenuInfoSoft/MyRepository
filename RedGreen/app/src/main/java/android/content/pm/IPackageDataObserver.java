...
/**
 * API for package data change related callbacks from the Package Manager. Some
 * usage scenarios include deletion of cache directory, generate statistics
 * related to code, data, cache usage(TODO) {@hide}
 */
public interface IPackageDataObserver extends android.os.IInterface {
	...
	abstract class Stub extends android.os.Binder implements
		 ...
		 * android.content.pm.IPackageDataObserver interface, generating a proxy
		 * if needed.
		 */
		...
		private static class Proxy implements
			...
			@Override
			public void onRemoveCompleted(java.lang.String packageName,
	...
	void onRemoveCompleted(java.lang.String packageName,
						   boolean succeeded) throws android.os.RemoteException;
}
