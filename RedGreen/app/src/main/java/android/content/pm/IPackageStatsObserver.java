...
public interface IPackageStatsObserver extends android.os.IInterface {
	...
	abstract class Stub extends android.os.Binder implements
		 ...
		 * android.content.pm.IPackageStatsObserver interface, generating a
		 * proxy if needed.
		 */
		...
		public boolean onTransact(int code, android.os.Parcel data,
			...
			case TRANSACTION_onGetStatsCompleted: {
				...
				if ((0 != data.readInt())) {
					_arg0 = android.content.pm.PackageStats.CREATOR
		...
		private static class Proxy implements
			...
			public void onGetStatsCompleted(
					android.content.pm.PackageStats pStats, boolean succeeded)
					throws android.os.RemoteException {
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_onGetStatsCompleted,
	...
	void onGetStatsCompleted(android.content.pm.PackageStats pStats,
