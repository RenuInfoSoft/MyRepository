...
public class LinearColorBar extends LinearLayout {
	...
	private int mLastLeftDiv, mLastRightDiv;
	private int mLastRegion;
	private static final int LEFT_COLOR = 0xff009688;
	private static final int MIDDLE_COLOR = 0xff009688;
	private static final int RIGHT_COLOR = 0xffced7db;
	...
	public static final int REGION_ALL = REGION_RED | REGION_YELLOW
			| REGION_GREEN;
	...
	public void setRatios(float red, float blue, float green) {
		mRedRatio = red;
		mBlueRatio = blue;
		mGreenRatio = green;
		invalidate();
	}
	public void setRatiosOne(float red) {
		mRedRatio = red;
		invalidate();
	}
	public void setRatiosTwo(float blue) {
		mRedRatio = blue;
		invalidate();
	}
	public void setRatiosThree(float green) {
		mRedRatio = green;
		invalidate();
	}
	...
	public void setColorsOne(int red) {
		mLeftColor = red;
		updateIndicator();
		invalidate();
	}
	public void setColorsTwo(int blue) {
		mLeftColor = blue;
		updateIndicator();
		invalidate();
	}
	public void setColorsThree(int green) {
		mLeftColor = green;
		updateIndicator();
		invalidate();
	}
		...
		if (mShowingGreen) {
			mColorGradientPaint
					.setShader(new LinearGradient(0, 0, 0, off - 2,
							mRightColor & 0xffffff, mRightColor,
							Shader.TileMode.CLAMP));
		} else {
			mColorGradientPaint.setShader(new LinearGradient(0, 0, 0, off - 2,
					mMiddleColor & 0xffffff, mMiddleColor,
					Shader.TileMode.CLAMP));
		}
	...
	protected void onDraw(Canvas canvas) {
		...
		int right2 = right + (int) (width * mBlueRatio);
