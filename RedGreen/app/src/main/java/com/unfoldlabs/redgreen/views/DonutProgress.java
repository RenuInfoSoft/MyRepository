package com.unfoldlabs.redgreen.views;
...
public class DonutProgress extends View {
	...
	private final int default_finished_color = Color.rgb(160, 52, 21);//
	private final int default_unfinished_color = Color.rgb(114, 144, 4);// Gray
																		// color
	private final int default_text_color = Color.rgb(255, 255, 255); // blue
																		// color
	private final int default_inner_bottom_text_color = Color
			.rgb(255, 255, 255);
	private final int default_inner_background_color = Color.rgb(139, 178, 1);
	...
	/**
	 * Constructor for DonutProgress with parameter Context
	 * @param context
	 */
	...
	/**
	 * Constructor for DonutProgress with parameters Context and AttributeSet
	 * @param context
	 * @param attrs
	 */
	...
	/**
	 * Constructor for DonutProgress with parameters Context, AttributeSet and defStyleAttr
	 * @param context
	 * @param attrs
	 * @param defStyleAttr
	 */
	...
	public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		default_text_size = Utility.sp2px(getResources(), 18);
		min_size = (int) Utility.dp2px(getResources(), 150);
		default_stroke_width = Utility.dp2px(getResources(), 100);
		default_inner_bottom_text_size = Utility.sp2px(getResources(), 18);
	...
	/**
	 * method to initialize the paint
	 */
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawArc(unfinishedOuterRect, getProgressAngle(), 360, false,
				unfinishedPaint);
		...
		if (!TextUtils.isEmpty(getInnerBottomText())) {
			...
			float bottomTextBaseline = getHeight() - innerBottomTextHeight
					- (textPaint.descent() + textPaint.ascent() + 20) / 2;
